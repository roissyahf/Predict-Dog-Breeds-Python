...
def calculates_results_stats(results_dic):
    ...
    # set all counters of initial value of zero
    ...
    # iterate over all keys in results_dic
    for key in results_dic:
        ...
        # counts how many pet images of dogs had their breed correctly classified
        # this happens when the pet image label and the classifier label match
    ...
    # Calculates run statistics (counts & percentages) using the counters from above.
